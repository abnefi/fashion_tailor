...
//suppression
  ...
  Future<Couturier> getCouturier(int id) async {
    ...
    List<Map> result = await dbCouturier.query(tableCouturier,
        columns: [column_idcouturier,column_nomcouturier,column_prenomcouturier,column_sexecouturier,column_telephonecouturier,column_specialitecouturier,column_typecouturier,column_localisationcouturier,column_iduser_c],
