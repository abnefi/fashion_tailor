    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Hero(
            tag: modele.imgmodele,
            child: Container(
              height: size.height * 0.7,
              decoration: BoxDecoration(
                image:
                DecorationImage(
                  image: NetworkImage(modele.imgmodele),
                  fit: BoxFit.cover,
                ),
              ),
              child: Container(
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage(modele.imgmodele),
                                    fit: BoxFit.cover,
                                  ),
                                  shape: BoxShape.circle,
                                ),
