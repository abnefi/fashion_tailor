...
class Constants{
  ...
  static const List<String> choices = <String> [
    Parametres,NouveauCouturier,NewPhoto,Slider,Deconnexion
  ];
}
...
class _ContenuAccueilState extends State<ContenuAccueil> {
  ...
  List<String> photos = [
    'assets/modele_femme_image1.jpg',
    'assets/modele_femme_image2.jpg',
    'assets/modele_homme_image3.jpg',
    'assets/modele_homme_image4.jpg',
    'assets/modele_couple_image5.jpg',
    'assets/modele_couple_image6.jpg',
    'assets/modele_enfant_image7.jpg',
  ];
